    ...
    <div className="h-screen flex items-center justify-between p-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        <SignIn.Root>
          ...
          {/* Paso si el usuario olvido su contraseña */}
          <SignIn.Step
          ...
          {/* Paso si el usuario decide resetear su contraseña */}
          <SignIn.Step name="reset-password">
            ...
            <Clerk.Field name="confirmPassword" className="flex flex-col gap-2 mt-4">
            ...
            <SignIn.Action 
              submit 
              className="mt-4 bg-iconBlue text-white rounded-full p-2 w-72 text-center font-bold"
            >
              Reset password
            </SignIn.Action>
          </SignIn.Step>
